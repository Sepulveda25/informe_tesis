\chapter{Iteración 1: “Elección de la solución”}
   ...
   \begin{subsubsection}{Elasticsearch}
    ...
    \begin{subsubsection}{Kibana}
     ...
     \begin{figure}[H]
        ...
        \end{figure}
   \end{subsubsection}
   \begin{subsection}{Elastic, ElastAlert, TheHive y Cortex}
   ...
   \end{subsection}
   \begin{subsection}{Analizando y clasificando eventos: ElastAlert}
   ...
   \end{subsection}
   \begin{subsection}{El panel de control general: TheHive y Cortex}
